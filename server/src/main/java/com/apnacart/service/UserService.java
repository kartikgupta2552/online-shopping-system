...
public interface UserService {
	...
	UserResponseDto getUserResponseById(Long userId);  //get user by id
	List<UserResponseDto> getAllUserResponses(); //get all users
	UserResponseDto authenticateUser(UserLoginDto loginDto); //user login - get user by email and password
